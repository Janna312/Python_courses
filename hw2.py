...
print(type(result_sum), result_sum)
...
print(type(result_subtr), result_subtr)
...
print(type(result_multi), result_multi)
...
print(type(result_exp), result_exp)
...
print(type(result_m_exp), result_m_exp)
